...
- pnpm install --save @iconify/json 安装Iconify 全量图标库
- pnpm add -D unocss  安装unocss原子类
- pnpm add sass -D 安装sass预处理器
- pnpm add pinia-plugin-persistedstate 安装pinia持久化插件
- pnpm create vue@latest   搭建模版
- pnpm add vite-plugin-svg-icons -D  Vite 生态中SVG 处理插件
